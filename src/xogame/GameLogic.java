...
public class GameLogic {
    ...
    char [][] grid; // a 2D array of chars representing the game grid
    ...
    public void newReplay(boolean twoPlayer)
    {
    ...
    public String checkGameWinner(char [][]grid){
        ...
        for(int rowIndex = 0;rowIndex < 3;rowIndex++){
            ...
            if(xFlag == 3){result = "X wins";winner="X";break;}
            else{xFlag  = 0; }
            if(oFlag == 3){result = "O wins";winner="O";break;}
            else{oFlag  = 0; }
        }
        //checks for Columns
        for(int colIndex = 0;colIndex < 3;colIndex++){
        ...
        if(xFlag == 3){result = "X wins";winner="X";}
        else if(oFlag == 3){result ="O wins";winner="O";}
